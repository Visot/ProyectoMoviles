...
public class MiGLRenderer implements GLSurfaceView.Renderer {

    private static final String TAG = "MiGLRenderer";
    private Triangulo mTriangle;
    private Cuadrado mSquare;
...
//        GLES20.glClearColor(1.0f, 1.0f, 1.0f, 0.5f);
        ...
        mTriangle = new Triangulo();
        mSquare   = new Cuadrado();
